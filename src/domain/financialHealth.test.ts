...
describe('computeHealthScore', () => {
  ...
  it('flags green savings rate when income >> spending', () => {
    const txns = [
      txn({ amount: 1000000, date: '2026-04-01' }),  // $10000 income
      txn({ amount: -100000, date: '2026-04-05' }),   // $1000 spend → 90% savings
    ];
  ...
  it('overall score is 0..100', () => {
    const sc = computeHealthScore([checking, savings], [
      txn({ amount: 500000, date: '2026-04-01' }),
      txn({ amount: -100000, date: '2026-04-05' }),
